...
export default function CreateBlog() {
  ...
  return (
    <>
      ...
      <form action='https://caterwauling-nickel-apple.glitch.me/createBlog' method='post' encType='multipart/form-data' className="bg-transparent bg-gray-700 font-semibold hover:drop-shadow-lg drop-shadow p-8 mx-60">
